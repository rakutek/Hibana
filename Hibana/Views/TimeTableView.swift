...
class DJ : ObservableObject {
    @Published var DJMock: [DJModel] = [
        DJModel(id: 1, name: "TAISUKE", sex: "men", start: "2020-11-09T14:09:30Z", active: true,description:"ヤッホ〜〜〜TAISUKE",genre:["EDM","HIP HOP","BASS"]),
        
        DJModel(id: 2, name: "MASAHIRO", sex: "men", start: "2020-11-09T14:15:00Z", active: true,description:"ヤッホ〜〜〜masahiro",genre:["EDM","HIP HOP","BASS","TRANCE"]),
